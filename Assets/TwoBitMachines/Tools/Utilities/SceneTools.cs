...
namespace TwoBitMachines
{
        public static class SceneTools
        {
                ...
                public static void ModifyPercentH (ref float percent, Vector2 position, Vector2 size, Color color, float direction = 1f, float handleSize = 0.25f)
                {
                        ...
                        var fmh_300_71_638561463262068847 = Quaternion.identity; Vector2 moved = Handles.FreeMoveHandle(value, handleSize, Vector3.one, Handles.RectangleHandleCap);
                        if (percent > 0)
                ...
                public static void ModifyPercentV (ref float percent, Vector2 position, Vector2 size, Color color, float direction = 1f, float handleSize = 0.25f)
                {
                        ...
                        var fmh_325_71_638561463262089398 = Quaternion.identity; Vector2 moved = Handles.FreeMoveHandle(value, handleSize, Vector3.one, Handles.RectangleHandleCap);
                        if (percent > 0)
                ...
                public static bool MovePositionHandle (SerializedProperty position, Handles.CapFunction handle, Vector2 offset, float snap = 0.125f, float handleSize = 0.25f, bool repaint = true, UnityEditor.Editor editor = null)
                {
                        ...
                        var fmh_344_71_638561463262091603 = Quaternion.identity; Vector2 moved = Handles.FreeMoveHandle(value, handleSize, Vector3.one, handle);
                        if (value != moved)
                        {
                ...
                public static Vector2 MovePositionHandle (Vector2 position, Vector2 offset, float snap = 0.125f, float handleSize = 0.25f, bool repaint = true, UnityEditor.Editor editor = null)
                {
                        ...
                        var fmh_359_71_638561463262093299 = Quaternion.identity; Vector2 moved = Handles.FreeMoveHandle(value, handleSize, Vector3.one, Handles.RectangleHandleCap);
                        if (value != moved)
                        {
                                if (repaint && editor != null)
                                        editor.Repaint();
                ...
                {
                        Vector2 value = position + offset * handleSize;
                        var fmh_373_71_638561463262094917 = Quaternion.identity; Vector2 moved = Handles.FreeMoveHandle(value, handleSize, Vector3.one, Handles.DotHandleCap);
                ...
                {
                        Vector2 value = position + offset * handleSize;
                        var fmh_390_71_638561463262096549 = Quaternion.identity; Vector2 moved = Handles.FreeMoveHandle(value, handleSize, Vector3.one, Handles.CircleHandleCap);
                ...
                public static Vector2 MovePositionCircleHandle (Vector2 position, Color color, float snap = 0.25f, float handleSize = 0.75f)
                {
                        ...
                        var fmh_409_71_638561463262098170 = Quaternion.identity; Vector2 moved = Handles.FreeMoveHandle(value, handleSize, Vector3.one, Handles.CircleHandleCap);
                        Handles.color = previousColor;
                ...
                public static Vector2 MovePositionCircleHandle (Vector2 position, Vector2 offset, Color color, out bool changed, float snap = 0.125f, float handleSize = 0.75f)
                {
                        ...
                        Handles.color = color;
                        Vector2 value = position + offset * handleSize;
                        var fmh_426_71_638561463262099808 = Quaternion.identity; Vector2 moved = Handles.FreeMoveHandle(value, handleSize, Vector3.one, Handles.CircleHandleCap);
                        Handles.color = previousColor;
                        SceneTools.Circle(value, handleSize * 0.4f, Color.white);
                        if (value != moved)
                        {
                ...
                {
                        Vector2 value = position + offset * handleSize;
                        var fmh_460_71_638561463262101614 = Quaternion.identity; Vector2 moved = Handles.FreeMoveHandle(value, handleSize, Vector3.one, handle);
                        if (value != moved)
                        {
                                moved = Compute.Round(moved, snap) - offset * snap;
                                if (xAxis)
                ...
                {
                        Vector2 value = position + offset * handleSize;
                        var fmh_475_71_638561463262103325 = Quaternion.identity; Vector2 moved = Handles.FreeMoveHandle(value, handleSize, Vector3.one, Handles.RectangleHandleCap);
                        if (value != moved)
                        {
                                moved = Compute.Round(moved, snap) - offset * snap;
                                if (xAxis)
